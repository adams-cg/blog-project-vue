<template>
    <div class="mt-20">
        <!-- img -->
        <div>
            <img src="" alt="" class="w-72 h-72 rounded-lg bg-gray-400">
        </div>
        <!-- nome -->
        <div>
        ...
        <div class=" flex">
            ...
            <!-- mail -->
            <div class="cursor-pointer" @click="cambiaStatoMail">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="w-10 h-10">
                    <path fill="#204a6a"
            ...
            <p v-show="mostraMail" class="bg-slate-300 text-[18px]">ciaociao@ciao.com</p>
            </div>
        </div>
    </div>
</template>
...
export default {
    ...
    methods: {
        cambiaStatoMail() {
            this.mostraMail = !this.mostraMail
        }
    },
    props: ["nome", "cognome", "linkedin", "github"]
}
</script>