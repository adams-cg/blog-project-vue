<template>
    <div class="pt-[117px] flex justify-center items-center">
        <h1
            ...
            <svg class="fill-inherit w-[60px] ml-[-20px] pr-[20px]" version="1.1" id="Capa_1"
                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 37.4 37.4"
                xml:space="preserve">
    ...
    <div class="flex flex-col justify-center items-center font-extrabold text-[30px] md:text-[35px] lg:text-[40px]">
        <h1 class="from-slate-400 via-zinc-700 to-black bg-clip-text text-transparent bg-gradient-to-b">Documentazioni
        </h1>
    </div>
    <div class="flex justify-center items-center ">
        <p
            ...
            ancora. Queste roadmap delineano i percorsi consigliati per acquisire competenze e conoscenze cruciali in
            ciascuna area, aiutando gli sviluppatori a pianificare il loro percorso di apprendimento in modo mirato e
            progressivo. Indipendentemente dall'ambito di interesse, la nostra documentazione offre un prezioso supporto
            per chiunque voglia approfondire le proprie competenze e rimanere aggiornato sulle ultime tecnologie e best
